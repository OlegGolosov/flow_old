...
//    argv [1] = "correct";
//    argv [2] = "/home/ogolosov/Desktop/analysis/mc/sim_root/fileList.txt";
...
//    argv [3] = "dfdf";
//    //argv [3] = "calib.root";
//    argv [4] = "/home/ogolosov/Desktop/analysis/centrality/output/M/botv_12agev_psd44_d20_p3.root";
//    argv [5] = "/home/ogolosov/Desktop/analysis/pid/build/pid_getter.root";
    argv [1] = "analysis";
    argv [2] = "qn.root";
...
//	TString efficiencyPath = "/lustre/nyx/cbm/users/ogolosov/NA49_data/efficiency/pbpb40_eff.root";
  ...
  if (strcmp(argv[1], "correct")==0) {
    ...
    Qn::CorrectionTask task (argv[2], argv[3], argv[4], argv[5]);
    task.SetSetup(setup);
		task.SetEff(eff);
    task.SetIsSim(issim);
    task.Run();
